        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_MachineSettings_Projects_ProjectId",
                        column: x => x.ProjectId,
                        principalTable: "Projects",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.InsertData(
                table: "Settings",
                columns: new[] { "Id", "Currency", "DarkMode", "DefaultHourlyRate", "Theme" },
                values: new object[] { new Guid("a1e5b9c2-0d34-4f6a-8b7e-3c2d1a0f9e88"), "EUR", false, 8m, "Atelier" });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_MachineSettings_ProjectId",
